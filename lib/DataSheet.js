...
var DataSheet = function (_PureComponent) {
  ...
  _createClass(DataSheet, [{
    ...
    key: 'isCellDefined',
    value: function isCellDefined(i, j) {
      var data = this.props.data;
    ...
    value: function searchForNextSelectablePos(data, newLocation, jumpRow, offsets) {
      while (newLocation.i >= 0 && newLocation.i < data.length && newLocation.j < data[newLocation.i].length && newLocation.j >= 0 && !this.props.isCellNavigable(data[newLocation.i][newLocation.j], newLocation.i, newLocation.j, jumpRow)) {
